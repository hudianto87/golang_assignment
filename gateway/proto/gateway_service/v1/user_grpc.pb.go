...
func (c *userServiceClient) GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *emptypb.Empty) (*GetUserResponse, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/gateway_service/v1/user.proto",
}
