...
type WalletServiceClient interface {
	...
	DeleteWallet(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*MutationResponse, error)
}
...
func (c *walletServiceClient) DeleteWallet(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MutationResponse)
...
type WalletServiceServer interface {
	...
	DeleteWallet(context.Context, *DeleteRequest) (*MutationResponse, error)
...
func (UnimplementedWalletServiceServer) DeleteWallet(context.Context, *DeleteRequest) (*MutationResponse, error) {
...
func _WalletService_DeleteWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).DeleteWallet(ctx, req.(*DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
